...
public class SecurityConfig {
	...
	public DaoAuthenticationProvider authencationProvider() {
		DaoAuthenticationProvider authencationProvider = new DaoAuthenticationProvider();
		authencationProvider.setUserDetailsService(userDetailsService());
		authencationProvider.setPasswordEncoder(passwordEncoder());
